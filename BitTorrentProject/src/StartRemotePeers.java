...
public class StartRemotePeers {
    ...
    // Provide path to peerProcess file
    private static final String scriptPrefix = "java peerProcess.java ";
    ...
    public static void main(String[] args) {
        ...
        // Provide CISE username
        String ciseUser = "tucker";
        ...
        for (PeerInfo remotePeer : peerList) {
            try {
                JSch jsch = new JSch();
                // Provide path to your private key file, and include the passphrase in the second argument if needed
                jsch.addIdentity("/Users/user/.ssh/java", "");
